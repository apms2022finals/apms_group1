...
#define SENSOR 33 // Analog input pin that sensor is attached to
#define SENSORI 32
...
void loop() {
  ...
  Firebase.setFloat(firebaseData,"/APARTMENT B/VOLTAGE", sensor_maxV);
  Firebase.setFloat(firebaseData,"/APARTMENT B/CURRENT", ACC);
  Firebase.setFloat(firebaseData, "/APARTMENT B/Temperature (C)", 27);
}
